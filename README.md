...
3. Dubbelklik het bestand **InstallRclone.exe** om Rclone te installeren. Windows zegt dat het een onbekende app is, klik op **Meer informatie** en dan op **Toch uitvoeren**. Windows vraagt daarna "Wilt u toestaan dat deze app wijzigingen aan uw pc aanbrengt?", klik op **Ja**.
